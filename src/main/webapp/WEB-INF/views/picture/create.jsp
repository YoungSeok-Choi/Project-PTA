...
<DIV class='content_body'>
  ...
  <br><br><br>
   <FORM name='frm' method='POST' action='/api/test.do' class="form-horizontal"
             enctype="multipart/form-data">
    <input type="hidden" name="member_id" value="${categoryVO.member_id }"> 
    <input type="hidden" name="cate_id" value="${param.cate_id }">
    ...
    <div class="form-group">
       <label class="control-label col-md-2">이미지</label>
       <div class="col-md-10">
         <input type='file' class="form-control" name='file1MF' id='file1MF'  value='' placeholder="apiTest">
        <button type="submit" class="btn btn-primary">등록</button>
       </div>
    </div>   
